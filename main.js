...
document.getElementById("display_length_of_array").innerHTML=length_of_array    //How to loop the array ? the id to be refer for innerHTML is loop_the_array
...
var array = ""
for (i=0 ;i < fruits; i++){
    array = array + fruits[i] +"<br>";
}
document.getElementById("loop_the_array").innerHTML = array
